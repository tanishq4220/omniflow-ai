...
class DecisionEngine:
    ...
    def process_telemetry(self, t: TelemetryData) -> SystemState:
        ...
        resp = AgentResponse(cdi=cdi, wait_time=wait_time, safety_risk=risk, predicted_congestion=pred)
